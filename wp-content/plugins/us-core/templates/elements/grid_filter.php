...
if ( ! empty( $mobile_width ) ) {
	...
	$output .= '<button class="w-filter-list-closer" title="' . esc_attr( us_translate( 'Close' ) ) . '"></button>';
}
...
if ( ! empty( $mobile_width ) AND $output_items !== '' ) {
	...
	$output .= '<button class="w-btn us-btn-style_1">';
