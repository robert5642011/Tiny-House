...
if ( $show_on == 'image' ) {
	...
	$output .= '<button' . us_implode_atts( $image_atts + $amp_atts ) . '>' . $image_html . '</button>';
	...
	$output .= '<button' . us_implode_atts( $icon_atts + $amp_atts ) . '>' . us_prepare_icon_tag( $btn_icon ) . '</button>';
