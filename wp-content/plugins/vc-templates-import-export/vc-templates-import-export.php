<?php
/**
 * Plugin Name: Export & Import WPBakery Page Builder
 * Description: Export & Import Templates for WPBakery Page Builder (Saved Templates/My Templates) in few clicks
...
if ( ! class_exists( 'VC_Templates_Import_Export' ) ) {
	class VC_Templates_Import_Export {
		...
		public function show_vc_version_notice() {
			...
			echo '
        <div class="updated">
          <p>' . sprintf( __( '<strong>%s</strong> requires <strong><a href="http://bit.ly/vc-plugin" target="_blank">WPBakery Page Builder</a></strong> plugin to be installed and activated on your site.', 'vc_extend' ), $plugin_data['Name'] ) . '</p>
        </div>';
		}
							...
							<div class="tmu-box">
								...
								<ul>
									...
									<li><strong>Multi Choose</strong> – export multi choose templates you wish
										<a href="http://bit.ly/temport" target="_blank"><strong>(Premium version)</strong></a>.
									</li>
								...
								Download Premium version here >> <a href="http://bit.ly/temport" target="_blank"><strong>TEMPORT</strong></a>
		...
		public function export_tab() {
			...
			if ( $saved_templates ) {
				...
				$output .= '<tfoot>';
				$output .= '<tr>';
				$output .= '<td class="manage-column check-column"><input id="cb-select-all-1" disabled=disabled type="checkbox"></td><th scope="col" id="title" class="manage-column column-title"><strong><label for="cb-select-all-1">Select All (Download Premium version to use feature)</label></strong></th>';
				$output .= '</tr>';
				$output .= '</tfoot>';
				$output .= '</table>';
